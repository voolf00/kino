...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AboutCreatedUser.film_operatior'
        db.add_column('about_created_user', 'film_operatior',
                      self.gf('django.db.models.fields.CharField')(default='-', max_length=256),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AboutCreatedUser.film_operatior'
        db.delete_column('about_created_user', 'film_operatior')
    ...
    models = {
        ...
        'film.aboutcreateduser': {
            'Meta': {'object_name': 'AboutCreatedUser', 'db_table': "'about_created_user'"},
            'film_actors': ('django.db.models.fields.TextField', [], {'default': "'-'"}),
            'film_compozitor': ('django.db.models.fields.CharField', [], {'default': "'-'", 'max_length': '256'}),
            'film_id': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['film.Film']"}),
            'film_montaj': ('django.db.models.fields.CharField', [], {'default': "'-'", 'max_length': '256'}),
            'film_operatior': ('django.db.models.fields.CharField', [], {'default': "'-'", 'max_length': '256'}),
            'film_produsser': ('django.db.models.fields.CharField', [], {'default': "'-'", 'max_length': '256'}),
            'film_rejisser': ('django.db.models.fields.CharField', [], {'default': "'-'", 'max_length': '256'}),
            'film_scenarii': ('django.db.models.fields.CharField', [], {'default': "'-'", 'max_length': '256'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'film.film': {
            ...
            'film_date_public': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 7, 0, 0)'}),
