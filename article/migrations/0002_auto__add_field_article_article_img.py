...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.article_img'
        db.add_column('article', 'article_img',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, default='default.png', blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.article_img'
        db.delete_column('article', 'article_img')
    ...
    models = {
        'article.article': {
            ...
            'article_img': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'default': "'default.png'", 'blank': 'True', 'null': 'True'}),
